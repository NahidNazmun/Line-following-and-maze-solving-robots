...
boolean black_line = true;
byte analog_high = 700;
byte analog_low = 500;
int a;
int b;
...
start:
  ...
  boolean rg = false;
  if (a > analog_high && (sensorValues[3] > 2000 || sensorValues[4] > 2000))
  {
    unsigned int tm;
...
tsection:
  ...
  else if (b > analog_high && (sensorValues[3] > 2000 || sensorValues[4] > 2000))
  {
    analogWrite(l_pwm, 200);
    analogWrite(r_pwm, 200);
    do {
